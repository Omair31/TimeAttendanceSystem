...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        let department = UserDefaults.standard.value(forKey: "department") as? String
        if let name = name, let email = email, let phoneNumber = phoneNumber, let department = department {
            ...
            let viewController = storyBoard.instantiateViewController(identifier: "BeaconDetectionViewController") as! BeaconDetectionViewController
